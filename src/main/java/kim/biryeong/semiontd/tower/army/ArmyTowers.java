...
public final class ArmyTowers {
    ...
    private static final String SENTRY = "friendsandfoes:tuff_golem";
    ...
    public static final TowerType GUARD = tower(
            "army_guard_t1", "위병", 50, 190.0, 2.4, 6.0, 20, 55,
            visual(SENTRY, 0.9),
            List.of(
    ...
    public static final TowerType MILITARY_POLICE = tower(
            "army_military_police_t2", "헌병", 105, 320.0, 2.6, 11.0, 19, 85,
            visual(SENTRY, 1.1),
            List.of(
                    "<gray> 방패를 든 정면 방어 계열입니다. </gray>",
                    "<aqua> 받는 피해의 <yellow>12%</yellow>를 흘려보냅니다. </aqua>",
                    "<green> 계급 영향을 받지 않습니다. </green>"
            )
    );

    public static final TowerType MP_COMMANDER = tower(
            "army_mp_commander_t3", "헌병대장", 220, 620.0, 2.8, 20.0, 18, 110,
            visual(SENTRY, 1.3),
            List.of(
    ...
    public static final TowerType GOP_SENTRY = tower(
            "army_gop_sentry_t2", "GOP 초병", 100, 250.0, 2.6, 10.0, 19, 85,
            visual(SENTRY, 1.1),
            List.of(
    ...
    public static final TowerType OUTPOST_CHIEF = tower(
            "army_outpost_chief_t3", "초소장", 215, 470.0, 2.8, 18.0, 18, 110,
            visual(SENTRY, 1.3),
            List.of(
    ...
    public static final TowerType RECRUIT = tower(
            "army_recruit_t1", "훈련병", 50, 90.0, 6.0, 8.0, 13, 0,
            visual(RIFLE, 0.9),
            List.of(
                    "<gray> 계급이 오르는 유일한 계열입니다. </gray>",
                    "<aqua> 짬이 찰수록 공격력이 줄고 대신 후임을 강화합니다. </aqua>",
                    "<gray> 투구로 계급을 알 수 있습니다. 가죽 → 사슬 → 철 → 다이아. </gray>"
            )
    );

    public static final TowerType SPECIALIST = tower(
            "army_specialist_t2", "특급전사", 130, 140.0, 6.5, 18.0, 12, 0,
            visual(RIFLE, 1.05),
            List.of(
    ...
    public static final TowerType PLATOON_LEADER = tower(
            "army_platoon_leader_t3", "소대장", 280, 190.0, 7.0, 37.0, 11, 0,
            visual(RIFLE, 1.2),
            List.of(
    ...
    public static final TowerType GUNNER = tower(
            "army_gunner_t2", "포병", 130, 110.0, 7.5, 16.0, 16, 0,
            visual(ARTILLERY, 1.0),
            List.of(
                    "<gray> 사거리가 길고 느린 광역 계열입니다. </gray>",
                    "<light_purple> 공격이 반경 <yellow>2.5</yellow> 안의 적에게 <yellow>40%</yellow>로 퍼집니다. </light_purple>"
            )
    );

    public static final TowerType BATTERY_CHIEF = tower(
            "army_battery_chief_t3", "포대장", 280, 150.0, 8.5, 30.0, 15, 0,
            visual(ARTILLERY, 1.2),
            List.of(
                    "<gray> 광역 계열의 최종 형태입니다. 라인 전체를 덮습니다. </gray>",
                    "<light_purple> 공격이 반경 <yellow>3.5</yellow> 안의 적에게 <yellow>55%</yellow>로 퍼집니다. </light_purple>",
